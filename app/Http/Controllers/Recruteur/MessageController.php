...
class MessageController extends Controller
{
    ...
    public function archives()
    {
        ...
        return view('recruteur.messagerie-archives', compact('conversations'));
    }
    ...
    public function restaurer(Conversation $conversation)
    {
        ...
        return redirect()->route('recruteur.messagerie.archives')->with('success', 'Conversation restaurée.');
    }
