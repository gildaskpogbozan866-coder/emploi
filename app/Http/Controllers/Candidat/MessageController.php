...
class MessageController extends Controller
{
    public function index()
    {
        ...
        return view('candidat.messagerie', compact('conversations'));
    }
    ...
    public function show(Conversation $conversation)
    {
        ...
        $messages = $conversation->messages()->with('expediteur')->latest()->get()->reverse();
        ...
        return view('candidat.messagerie-detail', compact('conversation', 'messages', 'autre'));
    }
