<header class="site-header">
  <div class="nav-wrapper">
    <nav class="nav">
      ...
      <div class="nav__actions">
        ...
        <a href="{{ auth()->check() ? route('candidat.profil') : route('auth.inscription').'?role=candidat' }}" class="nav__cta">
  ...
  <div class="nav__mobile" id="mobileMenu">
    ...
    @if(!auth()->check() || auth()->user()->hasRole('candidat'))
    <a href="{{ auth()->check() ? route('candidat.profil') : route('auth.inscription').'?role=candidat' }}" class="nav__mobile-cta">Déposer mon CV</a>
    @endif
    @guest
