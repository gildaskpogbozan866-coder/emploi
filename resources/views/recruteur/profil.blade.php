...
<div class="rec-card" style="max-width:680px">
  <div class="rec-card__body">
    <form method="POST" action="{{ route('recruteur.profil.update') }}" enctype="multipart/form-data">
      ...
      <div style="background:rgba(55,138,221,0.06);border:1px solid rgba(55,138,221,0.18);border-radius:8px;padding:12px 16px;margin-bottom:18px;font-size:13px;color:#185FA5">
