      ...
      <div class="rec-form-grid">
        ...
        <div class="rec-form-group full">
          ...
          <div style="display:flex;flex-wrap:wrap;gap:10px">
            ...
            <label style="display:flex;align-items:center;gap:8px;padding:9px 14px;border:1.5px solid #d1d5db;border-radius:9px;cursor:pointer;font-weight:500;font-size:13.5px;background:#f9fafb;transition:border-color .15s">
