      ...
      <div class="rec-form-grid">
        ...
        <div class="rec-form-group full">
          ...
          <div style="display:flex;flex-direction:column;align-items:flex-start;gap:8px">
            <label style="display:inline-flex;align-items:center;gap:10px;padding:10px 16px;border:1.5px solid #d1d5db;border-radius:10px;cursor:pointer;font-weight:500;font-size:13.5px;background:#f9fafb;transition:border-color .15s"
