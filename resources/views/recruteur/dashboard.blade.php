...
{{-- Stats --}}
<div class="rec-stats">
  <a href="{{ route('recruteur.offres', ['statut' => 'active']) }}" class="rec-stat rec-stat--link">
  ...
  <a href="{{ route('recruteur.offres') }}" class="rec-stat rec-stat--link">
  ...
  <a href="{{ route('recruteur.candidatures') }}" class="rec-stat rec-stat--link">
  ...
  <a href="{{ route('recruteur.candidatures', ['statut' => 'envoyee']) }}" class="rec-stat rec-stat--link">
...
<div class="rec-grid-2" style="margin-top:20px">
  <div class="rec-card">
    ...
    <div class="rec-card__body" style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
      <a href="{{ route('recruteur.offres.create') }}" class="rec-btn rec-btn--yellow" style="justify-content:center">
