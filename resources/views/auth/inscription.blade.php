...
<div class="auth-page">
  ...
  <div class="auth-form-panel">
    <div class="auth-form-wrap">
      ...
      <div id="role-banner" style="display:none;background:#EBF4FD;border:1.5px solid #185FA5;border-radius:9px;padding:9px 14px;margin-bottom:14px;font-size:13px;font-weight:600;color:#042C53;display:flex;align-items:center;gap:8px">
        <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke="#185FA5" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
        Vous vous inscrivez en tant que : <span id="role-label" style="color:#185FA5;font-weight:800"></span>
      </div>
