...
@section('content')
@php
$contactMailSubject = urlencode('Aide pour commander « ' . $service->nom . ' »');
$contactMailBody    = urlencode('Bonjour, je souhaite commander « ' . $service->nom . ' » mais j\'ai besoin d\'aide pour remplir le formulaire.');
...
.cmd-wa-help {
  ...
  background: #eaf3fb; border: 1.5px solid #93c5fd;
