...
$waMessage = urlencode('Bonjour, je souhaite commander « ' . $service->nom . ' » mais j\'ai besoin d\'aide pour remplir le formulaire.');
...
.cmd-wa-help {
  ...
  background: #e7f9f0; border: 1.5px solid #86efac;
  border-radius: 12px; padding: 14px 18px;
  margin-bottom: 20px; flex-wrap: wrap;
}
.cmd-wa-help__text { font-size: 13px; line-height: 1.5; color: #166534; font-weight: 600; }
.cmd-wa-help__btn {
...
.cmd-wa-help__btn:hover { background: #16a34a; transform: translateY(-1px); }
.cmd-card__body {
  padding: 0 28px 24px;
  ...
  <div class="cmd-wrap">
    ...
    <div class="cmd-wa-help">
      <span class="cmd-wa-help__text">
        Nos conseillers vous aident sur WhatsApp à réaliser votre « {{ $service->nom }} »,
      ...
      <a href="{{ $waUrl }}" target="_blank" rel="noopener" class="cmd-wa-help__btn">
