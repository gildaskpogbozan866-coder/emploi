...
@section('description', 'CV professionnel, coaching, logo, site web… Des experts à votre service, livrés rapidement et à prix abordable.')
...
.svc-cta__btn--wa   { background: #185FA5; color: #fff; }
...
<section class="svc-hero">
  <div class="svc-hero__inner">
    <div>
      ...
      <p class="svc-hero__sub">CV, logo, site web, traduction… Des experts à votre service, livrés rapidement et à prix abordable.</p>
...
$cats = [
  [
    ...
    'slugs' => ['cv-professionnel','preparation-entretien','linkedin-optimise','coaching-entretien','creation-cv-documents'],
...
<div class="svc-cta">
  <div class="svc-cta__inner">
    ...
    <div class="svc-cta__btns">
      <a href="mailto:contact@emploibougebenin.com" class="svc-cta__btn svc-cta__btn--wa">
