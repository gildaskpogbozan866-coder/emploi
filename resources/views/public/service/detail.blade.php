...
.sdp-side-wa:hover { background: #dbeafe; }
...
$contactMailSubject = urlencode('Question sur le service « ' . $service->nom . ' »');
$contactMailBody    = urlencode('Bonjour, je suis intéressé(e) par votre service « ' . $service->nom . ' ». Pouvez-vous me donner plus d\'informations ?');
$contactMailUrl     = 'mailto:contact@emploibougebenin.com?subject=' . $contactMailSubject . '&body=' . $contactMailBody;
@endphp
  ...
  <div class="sdp-wrap">
    ...
    <div class="sdp-hero__inner">
      ...
      <div class="sdp-hero__pcard">
        ...
        @endif
        <a href="{{ $contactMailUrl }}" class="sdp-hero__pcard-wa">
    ...
    <div class="sdp-layout">
      ...
      <div class="sdp-sidebar">
        <div class="sdp-side-card">
          ...
          <a href="{{ $contactMailUrl }}" class="sdp-side-wa">
            <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="#185FA5" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
            Poser une question
          </a>
        </div>
  ...
  <div class="sdp-wrap">
    <div class="sdp-cta__inner">
      ...
      <div class="sdp-cta__btns">
        <a href="{{ $contactMailUrl }}" class="sdp-cta__btn sdp-cta__btn--wa">
