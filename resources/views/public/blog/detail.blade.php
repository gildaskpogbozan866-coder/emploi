  ...
  <div class="container">
    <div class="article-hero__inner">
      ...
      <nav class="breadcrumb">
        ...
        <span class="breadcrumb__sep">/</span>
        <span class="breadcrumb__current">{{ Str::limit($article->titre, 50) }}</span>
      </nav>

      @if($article->categorie)
        <span class="article-hero__tag">{{ $article->categorie }}</span>
      @endif
...
{{-- ══════════════════════ CONTENU + SIDEBAR ══════════════════════ --}}
<section class="section article-layout" style="{{ $article->image ? 'padding-top:32px' : '' }}">
  <div class="container">
    <div class="article-layout__inner">
      ...
      <main>
        ...
        <div class="article-nav">
          <a href="{{ route('blog.list') }}" class="article-nav__back">
            <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></svg>
            Retour au blog
          </a>
        </div>
      </main>
      ...
      <aside class="article-sidebar">
        ...
        <div class="sidebar-card">
          ...
          <ul class="sidebar-articles">
            ...
            <li class="sidebar-article">
              ...
              <time class="sidebar-article__date">
                {{ $sug->publie_le?->format('d M Y') }}
              </time>
            </li>
            @endforeach
          </ul>
        ...
        <div class="sidebar-card" style="background:#f0f7ff;border-color:#bfdbfe">
          ...
          <p style="font-size:13px;color:#475569;line-height:1.6;margin:0 0 14px">Des centaines d'offres vérifiées au Bénin, mise à jour chaque semaine.</p>
          <a href="{{ route('offre.list') }}"
             style="display:inline-flex;align-items:center;gap:6px;background:linear-gradient(135deg,#042C53,#185FA5);color:#F5C842;font-size:13px;font-weight:700;padding:10px 18px;border-radius:10px;text-decoration:none">
            Voir les offres →
          </a>
        </div>
