...
<div class="cvt-list">
@forelse($cvs as $item)
  @php $dispo = null; @endphp

  <a href="{{ route('cv.public.detail', $item) }}" style="display:block;background:#fff;border:1.5px solid #e8edf3;border-radius:16px;padding:20px;text-decoration:none;transition:box-shadow .18s,transform .18s;box-shadow:0 2px 8px rgba(4,44,83,.06)"
