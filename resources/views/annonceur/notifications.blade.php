...
@section('title', 'Notifications | Annonceur')
...
<div class="cand-page-header">
  ...
  <div class="cand-page-header__actions">
    <form method="POST" action="{{ route('annonceur.notifications.lues') }}">
      @csrf
  ...
  @empty
    <div class="cand-empty">
      <div class="cand-empty__icon">
        <svg width="26" height="26" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/></svg>
      </div>
